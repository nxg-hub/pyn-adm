    ...
    return(
        <div style={{backgroundColor: "rgb(11, 88, 114)", paddingTop:"15px", width: "100%", height:"100%", textAlign: "center", fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif, Times, serif"}}>
            ...
            <div style={{width: "90%", margin: "0 auto", color: "white", fontSize: "1.1rem", textAlign: "left", fontWeight: "bold"}}>
              <p>Dear {name},</p>
              <br/>
              <p>Your registration as an admin with the role {userType} has been successfully completed.</p>
              <p>You can now log into admin account using your email and the password you set during registration.</p>
              <p>If you did not complete this registration, please contact our support team immediately{email}. </p>
              <p>Thank you for joining our admin team!</p>
